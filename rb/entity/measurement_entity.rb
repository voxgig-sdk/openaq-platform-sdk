# OpenaqPlatform SDK Measurement entity
...
class MeasurementEntity
  ...
  def data_set(args)
    if args
      @_data = OpenaqPlatformHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  def match_set(args)
    if args
      @_match = OpenaqPlatformHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  # @return [Array<Measurement>, Array] the matching Measurement items; raises OpenaqPlatformError on failure
