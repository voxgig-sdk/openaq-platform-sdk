# OpenaqPlatform Ruby SDK

The Ruby SDK for the OpenaqPlatform API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.OpenaqPlatform(nil).load(
  { "id" => "test01" }, nil
)
...
```
rb/
├── OpenaqPlatform_sdk.rb       -- Main SDK module
