...
#      offline in seeded test mode (OpenaqPlatformSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "OpenaqPlatform_sdk.rb")
  SDK_CLASS = "OpenaqPlatformSDK"
