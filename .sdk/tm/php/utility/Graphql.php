...
// OpenaqPlatform SDK utility: graphql
//
...
class OpenaqPlatformGraphql
{
    ...
    // equivalent.
    public static function body(OpenaqPlatformContext $ctx): mixed
    {
    ...
    public static function errors(OpenaqPlatformContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
