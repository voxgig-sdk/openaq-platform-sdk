...
// OpenaqPlatform SDK timeout feature
...
class OpenaqPlatformTimeoutFeature extends OpenaqPlatformBaseFeature
{
    ...
    private function _with_timeout(OpenaqPlatformContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(OpenaqPlatformContext $_ctx, float $ms): void
    {
        $client = $this->client;
