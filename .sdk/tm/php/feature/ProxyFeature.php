...
// OpenaqPlatform SDK proxy feature
...
class OpenaqPlatformProxyFeature extends OpenaqPlatformBaseFeature
{
    ...
    public function init(OpenaqPlatformContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (OpenaqPlatformContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
