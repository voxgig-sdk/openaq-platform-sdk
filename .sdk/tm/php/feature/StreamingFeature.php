...
// OpenaqPlatform SDK streaming feature
...
class OpenaqPlatformStreamingFeature extends OpenaqPlatformBaseFeature
{
    ...
    private function _iterate(OpenaqPlatformResult $result): \Generator
    {
    ...
    private function _streamable(OpenaqPlatformContext $ctx): bool
    {
