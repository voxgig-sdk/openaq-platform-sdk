...
// OpenaqPlatform SDK netsim feature
...
class OpenaqPlatformNetsimFeature extends OpenaqPlatformBaseFeature
{
    ...
    private function _simulate(OpenaqPlatformContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(OpenaqPlatformContext $ctx, array $applied): void
    {
        $client = $this->client;
