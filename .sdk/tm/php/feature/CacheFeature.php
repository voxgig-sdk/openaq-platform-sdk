...
// OpenaqPlatform SDK cache feature
...
class OpenaqPlatformCacheFeature extends OpenaqPlatformBaseFeature
{
    ...
    private function _through(OpenaqPlatformContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
