...
// OpenaqPlatform SDK metrics feature
...
class OpenaqPlatformMetricsFeature extends OpenaqPlatformBaseFeature
{
    ...
    private function _record(OpenaqPlatformContext $ctx, bool $ok): void
    {
