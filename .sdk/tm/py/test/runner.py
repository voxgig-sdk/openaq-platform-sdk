...
class OpenaqPlatformTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = OpenaqPlatformTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = OpenaqPlatformTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = OpenaqPlatformTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
