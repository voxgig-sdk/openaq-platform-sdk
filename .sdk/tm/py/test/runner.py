...
class OpenaqPlatformTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = OpenaqPlatformTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = OpenaqPlatformTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = OpenaqPlatformTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
