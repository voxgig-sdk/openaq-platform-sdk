...
|---|---|---|
| `ts/` | @voxgig-sdk/openaq-platform-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/openaq-platform-sdk \
      --repository voxgig-sdk/openaq-platform-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/openaq-platform-sdk` shows it, and
`npm trust revoke @voxgig-sdk/openaq-platform-sdk --id=<id>` removes it.
