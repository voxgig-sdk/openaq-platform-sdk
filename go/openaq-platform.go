...
// instead of `sdk.NewOpenaqPlatformSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *OpenaqPlatformSDK  { return NewOpenaqPlatformSDK(nil) }
func Test() *OpenaqPlatformSDK { return TestSDK(nil, nil) }
