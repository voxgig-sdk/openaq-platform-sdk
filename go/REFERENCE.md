# OpenaqPlatform Golang SDK Reference

Complete API reference for the OpenaqPlatform Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *OpenaqPlatformSDK`
...
#### `Location(data map[string]any) OpenaqPlatformEntity`

Create a new `Location` entity instance. Pass `nil` for no initial data.

#### `Measurement(data map[string]any) OpenaqPlatformEntity`
