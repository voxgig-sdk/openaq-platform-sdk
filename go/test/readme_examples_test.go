...
const testSeed = `map[string]any{"entity": map[string]any{"location": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "measurement": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
