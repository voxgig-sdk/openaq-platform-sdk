...
func (sdk *OpenaqPlatformSDK) OptionsMap() map[string]any {
...
func (sdk *OpenaqPlatformSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *OpenaqPlatformSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *OpenaqPlatformSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OpenaqPlatformSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *OpenaqPlatformSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *OpenaqPlatformSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("OpenaqPlatformSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *OpenaqPlatformSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OpenaqPlatformSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("OpenaqPlatformSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *OpenaqPlatformSDK {
	...
	sdk := NewOpenaqPlatformSDK(sdkopts)
	sdk.Mode = "test"
