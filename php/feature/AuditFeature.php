...
// OpenaqPlatform SDK audit feature
...
class OpenaqPlatformAuditFeature extends OpenaqPlatformBaseFeature
{
    ...
    private function _emit(OpenaqPlatformContext $ctx, string $outcome): void
    {
