...
// OpenaqPlatform SDK debug feature
...
class OpenaqPlatformDebugFeature extends OpenaqPlatformBaseFeature
{
    ...
    private function _finish(OpenaqPlatformContext $ctx, bool $ok): void
    {
