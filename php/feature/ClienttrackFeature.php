...
// OpenaqPlatform SDK clienttrack feature
...
class OpenaqPlatformClienttrackFeature extends OpenaqPlatformBaseFeature
{
    ...
    public function PostConstruct(OpenaqPlatformContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'OpenaqPlatform-SDK';
