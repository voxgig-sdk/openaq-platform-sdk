...
// OpenaqPlatform SDK telemetry feature
...
class OpenaqPlatformTelemetryFeature extends OpenaqPlatformBaseFeature
{
    ...
    private function _close(OpenaqPlatformContext $ctx, bool $ok): void
    {
