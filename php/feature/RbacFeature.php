...
// OpenaqPlatform SDK rbac feature
...
class OpenaqPlatformRbacFeature extends OpenaqPlatformBaseFeature
{
    ...
    private function _required(OpenaqPlatformContext $ctx): ?string
    {
    ...
    private function _reject(OpenaqPlatformContext $ctx, string $required): void
    {
    ...
    private function _track(OpenaqPlatformContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
