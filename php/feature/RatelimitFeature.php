...
// OpenaqPlatform SDK ratelimit feature
...
class OpenaqPlatformRatelimitFeature extends OpenaqPlatformBaseFeature
{
    ...
    private function _acquire(OpenaqPlatformContext $ctx): void
    {
    ...
    private function _track(OpenaqPlatformContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
