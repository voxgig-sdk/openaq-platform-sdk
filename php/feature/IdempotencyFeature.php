...
// OpenaqPlatform SDK idempotency feature
...
class OpenaqPlatformIdempotencyFeature extends OpenaqPlatformBaseFeature
{
    ...
    private function _mutating(OpenaqPlatformContext $ctx): bool
    {
