...
// OpenaqPlatform SDK utility type

class OpenaqPlatformUtility
{
    ...
    public static function copy(OpenaqPlatformUtility $src): OpenaqPlatformUtility
    {
        $u = new OpenaqPlatformUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
