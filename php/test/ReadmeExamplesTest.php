...
// OpenaqPlatform SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OpenaqPlatformSDK::test)
...
{
    private const SDK_CLASS = 'OpenaqPlatformSDK';
    ...
    private const SDK_BASE = 'openaqplatform_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../openaqplatform_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
