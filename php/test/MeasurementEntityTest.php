...
class MeasurementEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set OPENAQPLATFORM_TEST_MEASUREMENT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function measurement_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("OPENAQPLATFORM_TEST_MEASUREMENT_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["OPENAQPLATFORM_TEST_MEASUREMENT_ENTID"]);
