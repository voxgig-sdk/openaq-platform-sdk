# OpenaqPlatform PHP SDK



The PHP SDK for the OpenaqPlatform API — an entity-oriented client using PHP conventions.
...
```
php/
├── openaqplatform_sdk.php          -- Main SDK class
...
The main class (`openaqplatform_sdk.php`) exports the SDK class
...
// $location->matchGet() returns the last match criteria
```
