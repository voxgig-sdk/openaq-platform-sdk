...
The PHP SDK for the OpenaqPlatform API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Location(null)->list(null, null);
...
[$result, $err] = $client->OpenaqPlatform(null)->load(
    ["id" => "test01"], null
);
