...
// OpenaqPlatform SDK utility: fetcher

class OpenaqPlatformFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OpenaqPlatformSDK/1.0)';
    ...
    public static function call(OpenaqPlatformContext $ctx, string $fullurl, array $fetchdef): array
    {
