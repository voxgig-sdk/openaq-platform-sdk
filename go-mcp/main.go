// Command OpenaqPlatform-mcp is an MCP server exposing the OpenaqPlatform
// SDK as MCP tools.
//
// Two tools are registered:
//
//	OpenaqPlatform_list  — list records of an entity
//	OpenaqPlatform_load  — load a single record of an entity
//
