...
type Args struct {
	Entity string         `json:"entity" jsonschema:"location | measurement"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.OpenaqPlatformSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "openaq-platform_list",
		Description: "List records from OpenaqPlatform. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "openaq-platform_load",
		Description: "Load a single record from OpenaqPlatform. " +
...
func runOp(client *sdk.OpenaqPlatformSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.OpenaqPlatformSDK, name string) (sdk.OpenaqPlatformEntity, error) {
