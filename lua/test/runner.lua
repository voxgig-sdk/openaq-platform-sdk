...
function runner.env_override(m)
  local live = runner.getenv("OPENAQ_PLATFORM_TEST_LIVE")
  local override = runner.getenv("OPENAQ_PLATFORM_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("OPENAQ_PLATFORM_TEST_EXPLAIN")
