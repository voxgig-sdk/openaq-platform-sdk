...
function runner.env_override(m)
  local live = runner.getenv("OPENAQPLATFORM_TEST_LIVE")
  local override = runner.getenv("OPENAQPLATFORM_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("OPENAQPLATFORM_TEST_EXPLAIN")
