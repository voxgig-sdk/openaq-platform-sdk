...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.OPENAQPLATFORM_TEST_LIVE ||
    'TRUE' === process.env.OPENAQPLATFORM_TEST_OVERRIDE
  ) {
  ...
  m.OPENAQPLATFORM_TEST_EXPLAIN = process.env.OPENAQPLATFORM_TEST_EXPLAIN || m.OPENAQPLATFORM_TEST_EXPLAIN
