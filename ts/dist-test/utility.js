...
function envOverride(m) {
    if ('TRUE' === process.env.OPENAQ_PLATFORM_TEST_LIVE ||
        'TRUE' === process.env.OPENAQ_PLATFORM_TEST_OVERRIDE) {
    ...
    m.OPENAQ_PLATFORM_TEST_EXPLAIN = process.env.OPENAQ_PLATFORM_TEST_EXPLAIN || m.OPENAQ_PLATFORM_TEST_EXPLAIN;
    return m;
}
