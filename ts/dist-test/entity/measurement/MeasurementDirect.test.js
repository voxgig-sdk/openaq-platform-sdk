...
(0, node_test_1.describe)('MeasurementDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.OpenaqPlatformSDK({
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.OpenaqPlatformSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['OPENAQ_PLATFORM_TEST_MEASUREMENT_ENTID'];
    ...
    const client = new __1.OpenaqPlatformSDK({
        base: 'http://localhost:8080',
