...
exports.OpenaqPlatformEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends OpenaqPlatformEntityBase<Advice>`.
class OpenaqPlatformEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.OpenaqPlatformEntityBase = OpenaqPlatformEntityBase;
//# sourceMappingURL=OpenaqPlatformEntityBase.js.map