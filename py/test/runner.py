...
class OpenaqPlatformTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = OpenaqPlatformTestRunner.getenv("OPENAQPLATFORM_TEST_LIVE")
        override = OpenaqPlatformTestRunner.getenv("OPENAQPLATFORM_TEST_OVERRIDE")
        ...
        explain = OpenaqPlatformTestRunner.getenv("OPENAQPLATFORM_TEST_EXPLAIN")
