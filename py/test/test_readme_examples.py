# OpenaqPlatform SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OpenaqPlatformSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OpenaqPlatformSDK(...) and OpenaqPlatformSDK.test(...) become
#      OpenaqPlatformSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "openaqplatform_sdk"
_SDK_CLASS = "OpenaqPlatformSDK"
