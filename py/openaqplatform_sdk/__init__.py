...
from openaqplatform_sdk.utility import register

# Load features
from openaqplatform_sdk.feature.base_feature import OpenaqPlatformBaseFeature
from openaqplatform_sdk.features import _has_feature, _make_feature
...
class OpenaqPlatformSDK:
    ...
    def get_utility(self):
        return OpenaqPlatformUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("OpenaqPlatformSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Location(self, data=None) -> "LocationEntity":
        ...
        from openaqplatform_sdk.entity.location_entity import LocationEntity
    ...
    def Measurement(self, data=None) -> "MeasurementEntity":
        ...
        from openaqplatform_sdk.entity.measurement_entity import MeasurementEntity
