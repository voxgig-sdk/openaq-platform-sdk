...
func registerSDKWords(r *eng.Registry, client *sdk.OpenaqPlatformSDK) {
...
func runOp(client *sdk.OpenaqPlatformSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
